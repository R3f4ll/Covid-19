...
class Corona:
 ...
 def indonesia(self):
  ...
  for x in self.b:
   runtext.load('\x1b[37m[+] Positif : '+x['positif'])
   runtext.load('\x1b[37m[\x1b[32;1m*\x1b[37m]\x1b[32;1m Sembuh : '+x['sembuh'])
   runtext.load('\x1b[37m[\x1b[31m-\x1b[37m]\x1b[31m Meninggal Dunia : '+x['meninggal'])
   time.sleep(3)
  self.ask = raw_input('\x1b[37mPerlihatkan Provinsi? (y/n) ')
  if 'y' in self.ask:
   n = []
   for i in self.res:
   ...
   for a in n:
    ...
    print('\x1b[37m[+] Positif : '+str(a['Kasus_Posi']))
    print('\x1b[37m[\x1b[32;1m*\x1b[37m]\x1b[32;1m Sembuh : '+str(a['Kasus_Semb']))
    print('\x1b[37m[\x1b[31m-\x1b[37m]\x1b[31m Meninggal dunia : '+str(a['Kasus_Meni'])+'\x1b[37m')
  if 'n' in self.ask:
   exit()
 ...
 def all_country(self):
  ...
  while True:
   ...
   print('''\x1b[37m[+] Positif : {}
\x1b[37m[\x1b[32;1m*\x1b[37m]\x1b[32;1m Sembuh : {}
\x1b[37m[\x1b[31m-\x1b[37m]\x1b[31m Meninggal Dunia : {}\x1b[37m'''.format(self.xx.group(1),self.xx.group(2),self.xx.group(3)))
